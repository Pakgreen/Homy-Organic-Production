...
export default function SignUpPage() {
  ...
  return (
    <div className="flex flex-col relative items-center justify-center bg-white px-4 pt-14 pb-6 sm:py-8 min-h-[calc(100vh-160px)] md:min-h-[calc(100vh-120px)]">
      <button
        onClick={() => router.back()}
        className="absolute top-4 left-4 sm:top-6 sm:left-6 p-2.5 text-gray-600 hover:text-gray-900 bg-gray-100/90 hover:bg-gray-200 rounded-full transition-colors z-20 cursor-pointer shadow-2xs"
        aria-label="Go back"
      >
      ...
      <div className="w-full max-w-md">
        <div className="rounded-3xl bg-white p-4 sm:p-8 md:p-9">
          {/* Top Toggle Bar (Sign In / Sign Up - Sleek Minimal Pill) */}
          <div className="flex bg-gray-100/80 p-1 rounded-full mb-6 border border-gray-200/60 max-w-xs mx-auto">
            <Link
              href="/auth/signin"
              className="flex-1 py-1.5 text-center text-xs font-semibold tracking-wide rounded-full text-gray-500 hover:text-gray-900 transition-all duration-200"
            >
              Sign In
            </Link>
            <Link
              href="/auth/signup"
              className="flex-1 py-1.5 text-center text-xs font-semibold tracking-wide rounded-full bg-black text-white shadow-xs transition-all duration-200"
            >
              Sign Up
            </Link>
          </div>
